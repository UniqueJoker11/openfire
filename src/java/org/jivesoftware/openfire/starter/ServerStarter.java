...
public class ServerStarter {
	 ...
	 * 由于openfire启动时在G:\program\openfire\target\openfire\bin目录下面，因此
	 * DEFAULT_LIB_DIR则在G:\program\openfire\target\openfire\lib目录下
	 */
	private static final String DEFAULT_LIB_DIR = "../lib";
	private static final String DEFAULT_ADMIN_LIB_DIR = "../plugins/admin/webapp/WEB-INF/lib";

	public static void main(String[] args) {
		// 这里一定要说明Openfire编译之后的目录，在启动的时候会去在这个目录下面找对应的openfire.xml配置文件和存放插件的目录
		/*System.setProperty("openfireHome",
				"G:\\program\\openfire\\target\\openfire");*/
	...
	private void start() {
		...
		try {
			...
			if (adminLibDirString == null) {
				...
				adminLibDirString = adminLibDirString
			...
			Class containerClass = loader
					.loadClass("org.jivesoftware.openfire.XMPPServer");
